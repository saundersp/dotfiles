...
map('n', '<leader>lo', lazy.home,    'Open Lazy plugin manager main menu')
map('n', '<leader>lp', lazy.profile, 'Open lazy loading profiling results')
...
map('n', '<leader>pp', '"+p',													   'Paste the system clipboard after the cursor')
map('n', '<leader>P', '"+P',													   'Paste the system clipboard before the cursor')
map('v', '<leader>y', '"+y',													   'Yank into the system clipboard')
map('n', '<leader>y', '"+Y',													   'Yank the entire buffer into the system clipboard')
